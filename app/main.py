...
from app.archives.legal_hold_router import hold_router as legal_hold_router, plan_router as disposal_plan_router
...
app.include_router(disposal_plan_router)
